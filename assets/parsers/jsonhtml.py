...
def item_to_row(item, columns):
    ...
    for col in columns:
        td = PQ('<td>')
        cell = item[col]
        if not isinstance(cell, (unicode, str, list, dict)):
...
update_file('/course/cs0111/www/assets/json/lectures.json',
            '/course/cs0111/www/lectures.html',
            'lectures-table-wrapper',
            'lectures-table',
            ['Date', 'Topic', 'Summary', 'Readings', 'Lecture Capture'],
            'Lectures')

update_file('/course/cs0111/www/assets/json/labs.json',
            '/course/cs0111/www/labs.html',
            'labs-table-wrapper',
            'labs-table',
            ['Week', 'Lab', 'Additional Materials'],
            'Labs')

update_file('/course/cs0111/www/assets/json/assignments.json',
            '/course/cs0111/www/assignments.html',
             'assignments-table-wrapper',
             'homeworks-table',
             ['Week', 'Assignment', 'Out', 'In', 'Support Docs'],
             'Homeworks')

update_file('/course/cs0111/www/assets/json/projects.json',
            '/course/cs0111/www/assignments.html',
             'projects-table-wrapper',
             'projects-table',
             ['Project', 'Out', 'In', 'Support Docs'],
             'Projects')

update_file('/course/cs0111/www/assets/json/drills.json',
            '/course/cs0111/www/assignments.html',
